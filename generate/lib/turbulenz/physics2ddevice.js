...
;
export class Physics2DMaterial {
    getElasticity() {
        return this._data[(0)];
    }
    getStaticFriction() {
...
export class Physics2DConstraint {
    // Abstract methods to be overridden by subclasses
    _inWorld() { debug.abort("abstract method"); }
    _outWorld() { debug.abort("abstract method"); }
    _pairExists(b1, b2) { debug.abort("abstract method"); return false; }
    _wakeConnected() { debug.abort("abstract method"); }
    _sleepComputation(union) { debug.abort("abstract method"); }
    _preStep(deltaTime) { debug.abort("abstract method"); return false; }
    _warmStart() { debug.abort("abstract method"); }
    _iterateVel() { debug.abort("abstract method"); return false; }
    _iteratePos() { debug.abort("abstract method"); return false; }
    init(con, params) {
        var data = con._data;
    ...
    rotateAnchor(data /*floatArray*/, body, LOCAL, RELATIVE) {
        var x = data[LOCAL];
        var y = data[LOCAL + 1];
        var cos = body[(5)];
        var sin = body[(5) + 1];
    ...
    // ================================================
    dtRatio(data /*floatArray*/, deltaTime) {
        var preDt = data[(4)];
    ...
    // ================================================
    _clearCache() { debug.abort("abstract method"); }
    clearCache() {
        var data = this._data;
        data[this._JACC] = 0;
        data[(4)] = -1;
    ...
    soft_params(data /*floatArray*/, KMASS, GAMMA, BIAS, deltaTime, breakUnderError) {
        var bias = data[BIAS];
        var bsq = (bias * bias);
        var maxError = data[(3)];
    ...
    soft_params2(data /*floatArray*/, KMASS, GAMMA, BIAS, deltaTime, breakUnderError) {
        var biasX = data[BIAS];
    ...
    soft_params3(data /*floatArray*/, KMASS, GAMMA, BIAS, deltaTime, breakUnderError) {
        var biasX = data[BIAS];
        var biasY = data[BIAS + 1];
    ...
    safe_solve(data /*floatArray*/, KMASS, ERR, IMP) {
        var err = data[ERR];
        var K = data[KMASS];
        data[IMP] = (K !== 0 ? (err / K) : 0);
    }
    safe_solve2(data /*floatArray*/, KMASS, ERR, IMP) {
        var errX = data[ERR];
        var errY = data[ERR + 1];
        var Ka = data[KMASS];
        var Kb = data[KMASS + 1];
    ...
    safe_solve3(data /*floatArray*/, KMASS, ERR, IMP) {
        var errX = data[ERR];
        var errY = data[ERR + 1];
        var errZ = data[ERR + 2];
        var Ka = data[KMASS];
    ...
    safe_invert(data /*floatArray*/, KMASS, JACC) {
        // Invert [K != 0] into [1 / K]
    ...
    safe_invert2(data /*floatArray*/, KMASS, JACC) {
        var Ka = data[KMASS];
        var Kb = data[KMASS + 1];
        var Kc = data[KMASS + 2];
        var det = ((Ka * Kc) - (Kb * Kb));
    ...
    safe_invert3(data /*floatArray*/, KMASS, JACC) {
        var Ka = data[KMASS];
        var Kb = data[KMASS + 1];
        var Kc = data[KMASS + 2];
        var Kd = data[KMASS + 3];
...
///*CUSTOM_JMAX*/5
///*CUSTOM_GAMMA*/6
export class Physics2DCustomConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "CUSTOM";
    }
...
export class Physics2DPulleyConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "PULLEY";
        this.dimension = 1;
...
export class Physics2DMotorConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "MOTOR";
        this.dimension = 1;
...
export class Physics2DLineConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "LINE";
        this.dimension = 2;
...
Physics2DLineConstraint.prototype._sleepComputation =
    Physics2DConstraint.prototype.twoBodySleepComputation;
export class Physics2DDistanceConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "DISTANCE";
        this.dimension = 1;
...
Physics2DDistanceConstraint.prototype._sleepComputation =
    Physics2DConstraint.prototype.twoBodySleepComputation;
export class Physics2DAngleConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "ANGLE";
        this.dimension = 1;
...
Physics2DAngleConstraint.prototype._sleepComputation =
    Physics2DConstraint.prototype.twoBodySleepComputation;
export class Physics2DWeldConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "WELD";
        this.dimension = 3;
...
Physics2DWeldConstraint.prototype._sleepComputation =
    Physics2DConstraint.prototype.twoBodySleepComputation;
export class Physics2DPointConstraint extends Physics2DConstraint {
    constructor() {
        super(...arguments);
        this.type = "POINT";
        this.dimension = 2;
...
export class Physics2DCircle extends Physics2DShape {
    constructor() {
        super();
        this.type = "CIRCLE";
    }
...
export class Physics2DPolygon extends Physics2DShape {
    constructor() {
        super();
        this.type = "POLYGON";
    }
    ...
    static create(params, inVertices) {
...
export class Physics2DRigidBody {
    isDynamic() {
        return (this._type === (0));
    }
    setAsDynamic() {
    ...
    // ===============================================================================
    applyImpulse(impulse /*v2*/, position /*v2*/) {
    ...
    setVelocityFromPosition(newPosition /*v2*/, newRotation, deltaTime) {
        if (this._type === (2)) {
            return;
        }
        var data = this._data;
    ...
    // ===============================================================================
    transformWorldPointToLocal(src /*v2*/, dst /*v2*/) {
        if (dst === undefined) {
            dst = new Physics2DDevice.prototype.floatArray(2);
        }
        var data = this._data;
    ...
    transformWorldVectorToLocal(src /*v2*/, dst /*v2*/) {
        if (dst === undefined) {
            dst = new Physics2DDevice.prototype.floatArray(2);
        }
        var data = this._data;
    ...
    transformLocalPointToWorld(src /*v2*/, dst /*v2*/) {
        if (dst === undefined) {
            dst = new Physics2DDevice.prototype.floatArray(2);
        }
        var data = this._data;
    ...
    transformLocalVectorToWorld(src /*v2*/, dst /*v2*/) {
        if (dst === undefined) {
            dst = new Physics2DDevice.prototype.floatArray(2);
        }
        var data = this._data;
    ...
    setSurfaceVelocity(surfaceVelocity /*v2*/) {
        var data = this._data;
    ...
    // ===============================================================================
    computeLocalCenterOfMass(dst /*v2*/) {
        if (dst === undefined) {
            dst = new Physics2DDevice.prototype.floatArray(2);
        }
        var comX = 0;
...
// Physics2D Callback
//
export class Physics2DCallback {
    constructor() {
        // All events
...
//
///*TOI_DATA_SIZE*/7
export class Physics2DTOIEvent {
    constructor() {
        this.next = null;
        this.shapeA = null;
        this.shapeB = null;
...
//
export class Physics2DBoxTreeBroadphaseHandle {
    constructor() {
        this.boxTreeIndex = -1;
        this.data = null;
        this.isStatic = false;
...
//
export class Physics2DSweepAndPruneHandle {
    constructor() {
        this._next = null;
        this._prev = null;
...
export class Physics2DSweepAndPrune {
...
export class Physics2DArbiter {
    ...
    // =====================================================================
    _preStep(deltaTime, timeStamp, continuous) {
...
export class Physics2DWorld {
    ...
    //         non-sleeping.
    _removeShape(shape, noCallbacks) {
        var body = shape.body;
    ...
    removeRigidBody(body, noCallbacks) {
        if (body.world !== this) {
            return false;
        }
        this._wakeBody(body);
    ...
    // =====================================================================
    rayCast(ray, noInnerSurfaces, customCallback, thisObject) {
    ...
    convexCast(shape, deltaTime, customCallback, thisObject) {
        var body = shape.body;
    ...
    _preStepArbiter(arb, deltaTime, progressEvents) {
    ...
    _wakeArbiter(arb, continuousCallbacks) {
        arb.sleeping = false;
    ...
    _continuousArbiterPrepare(arb, deltaTime, progressEvents) {
...
//
export class Physics2DCollisionUtils {
    containsPoint(shape, point /*v2*/) {
        shape.body._update();
        return this._contains(shape, point[0], point[1]);
    }
    signedDistance(shapeA, shapeB, witnessA /*v2*/, witnessB /*v2*/, axis /*v2*/) {
        shapeA.body._update();
    ...
    rayTest(shape, ray, normal /*v2*/, ignoreInnerSurfaces) {
        shape.body._update();
        return this._rayTest(shape, ray, normal, ignoreInnerSurfaces);
    }
    sweepTest(shapeA, shapeB, deltaTime, point /*v2*/, normal /*v2*/) {
        var toi = this._toi;
        toi.shapeA = shapeA;
        toi.shapeB = shapeB;
    ...
    _dynamicSweep(toi, timeStep, negRadius, slowSweep) {
        var s1 = toi.shapeA;
        var s2 = toi.shapeB;
        var b1 = s1.body;
        var b2 = s2.body;
    ...
    _staticSweep(toi, timeStep, negRadius) {
...
export class Physics2DDevice {
    ...
    createCircleShape(params) {
        return Physics2DCircle.create(params);
    }
    createPolygonShape(params) {
    ...
    createPointConstraint(params) {
        return Physics2DPointConstraint.create(params);
    }
    createWeldConstraint(params) {
    ...
    createRegularPolygonVertices(diameterX, diameterY, numVertices) {
