// var Box2D = function (Box2D) {
    ...
    if (ea) {
        ...
        quit(a)
    }), eval("if (typeof gc === 'function' && gc.toString().indexOf('[native code]') > 0) var gc = undefined"); else if (ca || da) b.read = function (a) {
        ...
        }), da && (b.load = importScripts), "undefined" === typeof b.setWindowTitle && (b.setWindowTitle = function (a) {
        document.title =
            a
    ...
    function Ba(a, c, d) {
        ...
        d = 4 == d ? e : ["function" === typeof Ca ? Ca : f.u, f.t, f.u, f.D][void 0 === d ? 2 : d](Math.max(l, m ? 1 : c.length));
        if (h) {
            e = d;
            assert(0 == (d & 3));
        ...
        if ("i8" === m)return a.subarray || a.slice ? Ea.set(a, d) : Ea.set(new Uint8Array(a), d), d;
        e = 0;
        for (var K, Da; e < l;) {
            var O = a[e];
            ...
            if (0 === h) e++; else {
                ...
                switch (pa) {
                    ...
                    case "i32":
                        ...
                        break;
                    case "i64":
                        tempI64 = [O >>> 0, (tempDouble = O, 1 <= +Fa(tempDouble) ? 0 < tempDouble ? (Ga(+Ha(tempDouble / 4294967296), 4294967295) | 0) >>> 0 : ~~+Ia((tempDouble - +(~~tempDouble >>> 0)) / 4294967296) >>> 0 : 0)];
                        oa[na >> 2] = tempI64[0];
                        oa[na + 4 >> 2] = tempI64[1];
                        break;
                    case "float":
    ...
    function Ja(a) {
        ...
        e = "";
        if (128 > d) {
            for (; 0 < c;)d = String.fromCharCode.apply(String, Ea.subarray(a, a + Math.min(c, 1024))), e = e ? e + d : d, a += 1024, c -= 1024;
            return e
        }
    ...
    function Na(a, c, d, e) {
        if (0 < e) {
            ...
            for (var h = 0; h < a.length; ++h) {
                ...
                55296 <= l && 57343 >= l && (l = 65536 + ((l & 1023) << 10) | a.charCodeAt(++h) & 1023);
                if (127 >= l) {
                    if (d >= e)break;
                    c[d++] = l
                } else {
    ...
    function Pa(a) {
        return a.replace(/__Z[\w\d_]+/g, function (a) {
            ...
            a:{
                ...
                if (e)try {
                    var h = a.substr(1), l = Oa(h) + 1, m = Ca(l);
                    Na(h, Ea, m, l);
                    var K = Ca(4), Da = e(m, 0, 0, K);
                    if (0 === wa(K) && Da) {
                        d = Ja(Da);
                        break a
                    }
    ...
    function sa() {
        va("Cannot enlarge memory arrays. Either (1) compile with  -s TOTAL_MEMORY=X  with X higher than the current value " + ra + ", (2) compile with  -s ALLOW_MEMORY_GROWTH=1  which allows increasing the size at runtime, or (3) if you want malloc to return NULL (0) instead of this abort, compile with  -s ABORTING_MALLOC=0 ")
    }

    var ab = b.TOTAL_STACK || 5242880, ra = b.TOTAL_MEMORY || 16777216;
    ra < ab && b.h("TOTAL_MEMORY should be larger than TOTAL_STACK, was " + ra + "! (TOTAL_STACK=" + ab + ")");
    b.buffer ? buffer = b.buffer : "object" === typeof WebAssembly && "function" === typeof WebAssembly.Memory ? (b.wasmMemory = new WebAssembly.Memory({
        initial: ra / 65536,
        maximum: ra / 65536
    }), buffer = b.wasmMemory.buffer) : buffer = new ArrayBuffer(ra);
    Ua();
    oa[0] = 1668509029;
    ya[1] = 25459;
    if (115 !== Ea[2] || 99 !== Ea[3])throw"Runtime error: expected the system to be little-endian!";
    b.HEAP = void 0;
    b.buffer = buffer;
    b.HEAP8 = xa;
    b.HEAP16 = ya;
    ...
    var Fa = Math.abs, Ia = Math.ceil, Ha = Math.floor, Ga = Math.min, mb = 0, nb = null, ob = null;
    ...
    (function (a) {
        function c(a, c) {
            var d = pa;
            if (0 > a.indexOf(".")) d = (d || {})[a]; else var e = a.split("."), d = (d || {})[e[0]],
                d = (d || {})[e[1]];
            c && (d = (d || {})[c]);
        ...
        function d(c) {
            ...
            rb || d.set(e.subarray(a.STATIC_BASE, a.STATIC_BASE + a.STATIC_BUMP), a.STATIC_BASE);
            e.set(d);
            b.buffer = buffer = c;
            Ua()
        }
        ...
        function e() {
            var c;
            if (a.wasmBinary) c = a.wasmBinary, c = new Uint8Array(c); else if (a.readBinary) c = a.readBinary(O); else throw"on the web, we need the wasm binary to be preloaded and set on Module['wasmBinary']. emcc.py will do that for you when generating HTML (but not JS)";
            return c
        }
        ...
        function l(c, d, e) {
            if ("function" !== typeof a.asm ||
                a.asm === Ya) a.asmPreload ? a.asm = a.asmPreload : eval(a.read(na));
        ...
        var Da = a.wasmTextFile || "Box2D_v2.3.1_min.wasm.wast",
            O = a.wasmBinaryFile || "Box2D_v2.3.1_min.wasm.wasm",
            na = a.asmjsCodeFile || "Box2D_v2.3.1_min.wasm.temp.asm.js", pa = {
        ...
        a.reallocBuffer = function (c) {
            var d =
                a.usingWasm ? 65536 : 16777216;
            0 < c % d && (c += d - c % d);
            var d = a.buffer, e = d.byteLength;
            if (a.usingWasm)try {
                return -1 !== a.wasmMemory.X((c - e) / 65536) ? a.buffer = a.wasmMemory.buffer : null
            } catch (h) {
                return null
        ...
        a.asm = function (h, Ka, O) {
            if (!Ka.table) {
                ...
                Ka.table = "object" === typeof WebAssembly && "function" === typeof WebAssembly.Table ? void 0 !== Ya ? new WebAssembly.Table({
                    initial: Xa, maximum: Ya,
                    element: "anyfunc"
                }) : new WebAssembly.Table({initial: Xa, element: "anyfunc"}) : Array(Xa);
                a.wasmTable = Ka.table
            }
            Ka.memoryBase || (Ka.memoryBase = a.STATIC_BASE);
            Ka.tableBase || (Ka.tableBase = 0);
            for (var P, Xa = K.split(","), Ya = 0; Ya < Xa.length; Ya++)if (P = Xa[Ya], a.printErr("trying binaryen method: " + P), "native-wasm" === P) {
                if (P = m(h, Ka))break
            } else if ("asmjs" === P) {
                if (P = l(h, Ka, O))break
            } else if ("interpret-asm2wasm" === P || "interpret-s-expr" === P || "interpret-binary" === P) {
                var La = h, ka = Ka, Nb = O;
                if ("function" !== typeof WasmJS) a.printErr("WasmJS not detected - polyfill not bundled?"),
                    P = !1; else {
                    var ta = WasmJS({});
                    ta.outside = a;
                    ta.info = pa;
                    ...
                    La = void 0;
                    La = "interpret-binary" === P ? e() : a.read("interpret-asm2wasm" == P ? na : Da);
                    ka = void 0;
                    if ("interpret-asm2wasm" == P) ka = ta._malloc(La.length + 1), ta.writeAsciiToMemory(La, ka), ta._load_asm2wasm(ka); else if ("interpret-s-expr" === P) ka = ta._malloc(La.length + 1), ta.writeAsciiToMemory(La,
                        ka), ta._load_s_expr2wasm(ka); else if ("interpret-binary" === P) ka = ta._malloc(La.length), ta.HEAPU8.set(La, ka), ta._load_binary2wasm(ka, La.length); else throw"what? " + P;
                    ta._free(ka);
                    ta._instantiate(ka);
            ...
            if (!P)throw"no binaryen method succeeded. consider enabling more options, like interpreting, if you want that: https://github.com/kripken/emscripten/wiki/WebAssembly#binaryen-methods";
    ...
    ma = Va + 23264;
    db.push();
    rb = 0 <= b.wasmJSMethod.indexOf("asmjs") || 0 <= b.wasmJSMethod.indexOf("interpret-asm2wasm") ? "Box2D_v2.3.1_min.wasm.js.mem" : null;
    b.STATIC_BASE = Va;
    b.STATIC_BUMP = 23264;
    var tb = ma;
    ma += 16;
    ...
    function Hb() {
        ...
        oa[Hb.buffer >> 2] = a;
        for (var a = Hb.buffer, h = 0; h < e.length; h++)if (e[h] && b.___cxa_can_catch(e[h], d, a))return a = oa[a >> 2], c.w = a, (f.f(e[h]), a) | 0;
        a = oa[a >> 2];
        return (f.f(d), a) | 0
    }
    ...
    function Jb(a, c) {
        Bb = c;
        try {
            var d = Cb(), e = Cb(), h = Cb(), l = 0;
            Jb.buffer || (Jb.e = [null, [], []], Jb.q = function (a, c) {
                var d = Jb.e[a];
                assert(d);
                if (0 === c || 10 === c) {
                    var e = 1 === a ? b.print : b.printErr, h;
                    a:{
                        for (var l = h = 0; d[l];)++l;
                        if (16 < l - h && d.subarray && Ma) h = Ma.decode(d.subarray(h, l)); else for (var m, K, P, O, ka, na, l = ""; ;) {
                            m = d[h++];
                            if (!m) {
                                h = l;
                                break a
                            }
                            m & 128 ? (K = d[h++] & 63, 192 == (m & 224) ? l += String.fromCharCode((m & 31) << 6 | K) : (P = d[h++] & 63, 224 == (m & 240) ? m = (m & 15) << 12 | K << 6 | P : (O = d[h++] & 63, 240 == (m & 248) ? m = (m & 7) << 18 | K << 12 | P << 6 | O : (ka = d[h++] & 63,
                                248 == (m & 252) ? m = (m & 3) << 24 | K << 18 | P << 12 | O << 6 | ka : (na = d[h++] & 63, m = (m & 1) << 30 | K << 24 | P << 18 | O << 12 | ka << 6 | na))), 65536 > m ? l += String.fromCharCode(m) : (m -= 65536, l += String.fromCharCode(55296 | m >> 10, 56320 | m & 1023)))) : l += String.fromCharCode(m)
                        }
                    }
                    e(h);
                    d.length = 0
            ...
            for (var m = 0; m < h; m++) {
                for (var K = oa[e + 8 * m >> 2], Da = oa[e + (8 * m + 4) >> 2], O = 0; O < Da; O++)Jb.q(d, Ea[K + O]);
                l += Da
            }
            return l
        } catch (na) {
    ...
    b.B = {
        abort: va, assert: assert, enlargeMemory: function () {
            sa()
        }, getTotalMemory: function () {
            return ra
        }, abortOnCannotGrowMemory: sa, invoke_iiii: function (a, c, d, e) {
            try {
            ...
            ua = !0;
            throw"Assertion failed: " + Ja(a) + ", at: " + [c ? Ja(c) : "unknown filename", d, e ? Ja(e) : "unknown function"] +
            " at " + Ra();
        }, __ZSt18uncaught_exceptionv: vb, ___setErrNo: function (a) {
            ...
            xb.push(a);
            a:{
                if (a && !yb[a])for (var d in yb)if (yb[d].w === a) {
                    c = d;
                    break a
                }
                c = a
        ...
        }, ___cxa_find_matching_catch: Hb, _pthread_getspecific: function (a) {
            return Eb[a] || 0
        }, _pthread_once: zb, ___syscall54: function (a, c) {
            Bb = c;
            return 0
            ...
            try {
                ...
                return "undefined" !==
                typeof FS && e instanceof FS.o || va(e), -e.r
            }
        }, ___syscall140: function (a, c) {
            Bb = c;
            try {
                var d = Db.G(), e = Cb(), h = Cb(), l = Cb(), m = Cb();
                assert(0 === e);
                FS.Z(d, h, m);
                oa[l >> 2] = d.position;
        ...
        }, ___syscall146: Jb, DYNAMICTOP_PTR: qa, tempDoublePtr: tb, ABORT: ua, STACKTOP: la, STACK_MAX: Za
    };
    ...
    var $c = b._emscripten_bind_b2FrictionJointDef_get_maxTorque_0 = function () {
        ...
        gd = b._emscripten_bind_b2PolygonShape_set_m_count_1 = function () {
            ...
            return b.asm._emscripten_enum_b2ManifoldType_e_circles.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2GearJoint_GetCollideConnected_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_enum_b2JointType_e_frictionJoint.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2PulleyJoint_GetBodyB_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2RopeJointDef_set_bodyB_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2WeldJoint_SetDampingRatio_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2AABB_Contains_1.apply(null,
                arguments)
        ...
        je = b._emscripten_bind_b2PolygonShape___destroy___0 = function () {
            ...
            return b.asm._emscripten_bind_b2GearJoint_GetUserData_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2CircleShape_set_m_type_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_JSRayCastCallback_ReportFixture_4.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2WheelJointDef_set_localAnchorA_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_enum_b2JointType_e_wheelJoint.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2FrictionJointDef_get_localAnchorA_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Mat33_get_ez_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2World_SetSubStepping_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2MotorJoint_GetReactionTorque_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Vec3_SetZero_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Shape_set_m_radius_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2ChainShape_set_m_vertices_1.apply(null,
                arguments)
            ...
            b._emscripten_bind_b2FixtureDef_get_isSensor_0 = function () {
            ...
            return b.asm._emscripten_bind_b2WheelJoint_EnableMotor_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2RevoluteJoint_GetJointAngle_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Profile_set_solvePosition_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2GearJoint___destroy___0.apply(null,
                arguments)
        ...
        Zf = b._emscripten_bind_b2MouseJoint_GetMaxForce_0 = function () {
            ...
            return b.asm._emscripten_bind_b2RevoluteJoint_GetMotorSpeed_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Mat33_b2Mat33_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2GearJointDef_set_ratio_1.apply(null,
                arguments)
    ...
    var ng = b._emscripten_bind_b2World_CreateJoint_1 = function () {
        ...
        }, rh = b._emscripten_bind_b2MotorJoint_SetUserData_1 =
            function () {
    ...
    var wh = b._emscripten_bind_b2Draw_AppendFlags_1 = function () {
        ...
        Ej = b._emscripten_bind_b2EdgeShape_Set_2 = function () {
            ...
            return b.asm._emscripten_bind_b2ManifoldPoint_get_normalImpulse_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2RayCastInput_set_p1_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2CircleShape_RayCast_4.apply(null,
                arguments)
    ...
    var Tj = b._emscripten_bind_b2DistanceJoint_GetLength_0 = function () {
            ...
            return b.asm._emscripten_bind_b2WheelJoint_SetMaxMotorTorque_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Vec2_b2Vec2_2.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Body_GetWorldCenter_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Fixture_GetType_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2RopeJointDef_set_type_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2PrismaticJointDef_set_bodyB_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2PrismaticJoint_GetAnchorA_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Joint_GetUserData_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2RopeJointDef_set_maxLength_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2BodyDef_set_angle_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Body_IsBullet_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_JSDraw_DrawPolygon_3.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2MouseJointDef_set_maxForce_1.apply(null,
                arguments)
        ...
        Jl = b._emscripten_bind_b2PulleyJointDef_get_type_0 = function () {
            ...
            return b.asm._emscripten_bind_b2World_GetBodyCount_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2PrismaticJoint_GetAnchorB_0.apply(null,
                arguments)
        ...
        jm = b._emscripten_bind_b2PrismaticJoint_IsActive_0 = function () {
            ...
            return b.asm._emscripten_enum_b2JointType_e_weldJoint.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2PulleyJointDef_set_userData_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2RevoluteJointDef_b2RevoluteJointDef_0.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_b2Manifold_set_localPoint_1.apply(null,
                arguments)
            ...
            return b.asm._emscripten_bind_JSContactListener___destroy___0.apply(null,
                arguments)
    ...
    var Do = b._emscripten_bind_b2FrictionJoint___destroy___0 = function () {
        ...
        return b.asm._emscripten_bind_b2GearJoint_GetBodyB_0.apply(null,
            arguments)
        ...
        return b.asm._emscripten_bind_b2World_GetContactCount_0.apply(null,
            arguments)
        ...
        return b.asm._emscripten_bind_b2MassData_set_center_1.apply(null,
            arguments)
        ...
        return b.asm._emscripten_bind_b2Contact_SetFriction_1.apply(null,
            arguments)
        ...
        return b.asm._emscripten_bind_b2World_GetSubStepping_0.apply(null,
            arguments)
    ...
    f.H = b.getTempRet0;
    b.asm = Kb;
    if (rb)if ("function" === typeof b.locateFile ? rb = b.locateFile(rb) : b.memoryInitializerPrefixURL && (rb = b.memoryInitializerPrefixURL + rb), ea || fa) {
        ...
        if (b.memoryInitializerRequest) {
            var Kw = function () {
                ...
                200 !== a.status && 0 !== a.status ? (console.warn("a problem seems to have happened with Module.memoryInitializerRequest, status: " + a.status + ", retrying " + rb), Jw()) : Iw(a.response)
            };
            b.memoryInitializerRequest.response ? setTimeout(Kw, 0) : b.memoryInitializerRequest.addEventListener("load", Kw)
        } else Jw()
    }
    b.then = function (a) {
    ...
    b.callMain = b.O = function (a) {
        ...
        a = a || [];
        hb || (hb = !0, bb(db));
        var d = a.length + 1, e = [Ba(jb(b.thisProgram), "i8", 0)];
        c();
    ...
    function Nw(a) {
        ...
        null === Lw && (Lw = Date.now());
        if (!(0 < mb)) {
            if (b.preRun)for ("function" == typeof b.preRun && (b.preRun = [b.preRun]); b.preRun.length;)ib();
            bb(cb);
            0 < mb || b.calledRun || (b.setStatus ? (b.setStatus("Running..."),
                setTimeout(function () {
                    setTimeout(function () {
                        b.setStatus("")
                    }, 1);
    ...
    function Ow(a, c) {
        if (!c || !b.noExitRuntime) {
            if (!b.noExitRuntime && (ua = !0, la = void 0, bb(fb), b.onExit)) b.onExit(a);
            ea && process.exit(a);
            b.quit(a, new ja(a))
        }
    }
    ...
    function $w(a, c, d) {
        ...
        c && "object" === typeof c && (c = c.a);
        d && "object" === typeof d && (d = d.a);
        this.a = void 0 === a ? fg() : void 0 === c ? _emscripten_bind_b2Mat33_b2Mat33_1(a) : void 0 === d ? _emscripten_bind_b2Mat33_b2Mat33_2(a, c) : Gt(a, c, d);
        k($w)[this.a] = this
    }
    ...
    function r(a, c) {
        a && "object" === typeof a && (a = a.a);
        c && "object" === typeof c && (c = c.a);
        this.a = void 0 === a ? wg() : void 0 === c ? _emscripten_bind_b2Vec2_b2Vec2_1(a) : ek(a, c);
        k(r)[this.a] = this
    }
    ...
    function ax(a, c, d) {
        ...
        c && "object" === typeof c && (c = c.a);
        d && "object" === typeof d && (d = d.a);
        this.a = void 0 === a ? Jk() : void 0 === c ? _emscripten_bind_b2Vec3_b2Vec3_1(a) : void 0 === d ? _emscripten_bind_b2Vec3_b2Vec3_2(a, c) : Tk(a, c, d);
        k(ax)[this.a] = this
    }
    ...
    function nx(a, c, d, e) {
        ...
        d && "object" === typeof d && (d = d.a);
        e && "object" === typeof e && (e = e.a);
        this.a = void 0 === a ? Mr() : void 0 === c ? _emscripten_bind_b2Mat22_b2Mat22_1(a) : void 0 === d ? Kr(a, c) : void 0 === e ? _emscripten_bind_b2Mat22_b2Mat22_3(a, c, d) : wu(a, c, d, e);
        k(nx)[this.a] = this
    }
    ...
    function tx(a, c) {
        a && "object" === typeof a && (a = a.a);
        c && "object" === typeof c && (c = c.a);
        this.a = void 0 === a ? Fh() : void 0 === c ? _emscripten_bind_b2Transform_b2Transform_1(a) : ns(a, c);
        k(tx)[this.a] = this
    }
    ...
    function ux(a, c, d) {
        ...
        c && "object" === typeof c && (c = c.a);
        d && "object" === typeof d && (d = d.a);
        this.a = void 0 === a ? Ws() : void 0 === c ? _emscripten_bind_b2Color_b2Color_1(a) : void 0 === d ? _emscripten_bind_b2Color_b2Color_2(a, c) : Vs(a, c, d);
        k(ux)[this.a] = this
    }
    ...
    M.prototype.SetAsBox = function (a, c, d, e) {
        ...
        d && "object" === typeof d && (d = d.a);
        e && "object" === typeof e && (e = e.a);
        void 0 === d ? tw(h, a, c) : void 0 === e ? _emscripten_bind_b2PolygonShape_SetAsBox_3(h, a, c, d) : yu(h, a, c, d, e)
    };
