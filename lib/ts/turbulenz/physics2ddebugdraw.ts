...
} from './physics2ddevice'

import {
    GraphicsDevice,
    debugphys2d_cgfx
} from '../PixiGraphicsDevice';
...
export class Physics2DDebugDraw
{
    ...
    private _techniqueParams: any;
    private _technique: any;

    private _vertexBufferParameters: any;
    private _vertexBuffer: any;
    private _semantics: any;
    private _indexBufferParameters: any;
